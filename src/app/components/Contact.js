...
function Contact() {
  ...
  return (
    <section
      id="ContactUs"
      className=" pb-10 pt-20 bg-white md:mt-0 flex items-center flex-col md:flex-row  gap-4  "
    >
      <div className=" flex flex-col text-center md:text-start md:px-10 px-2 md:w-1/2 gap-5 ">
        <motion.h1
          ...
          className=" text-6xl font-nova   text-[#0F0D0F]"
        >
          Get in Touch
        </motion.h1>
        <motion.p
          ...
          className=" font-nova-regular  text-[#0F0D0F]"
        >
        ...
        <motion.div
          ...
          className=" flex text-[#0F0D0F]  flex-col md:flex-row items-center gap-4"
        >
          <a
        ...
        >
          <a className="  text-[#0F0D0F]  inline-flex items-center gap-1 ">
            <svg
              width="30"
              height="30"
              viewBox="0 0 40 40"
      ...
      >
        <input
          ...
          className="  px-4  mt-5 pb-5 bg-transparent  w-4/5 border-b  focus:outline-none  placeholder:text-[#002B87B2]       placeholder:font-nova     "
          placeholder="Full name "
        />
        <input
          type="email"
          style={{ borderBottomColor: "rgba(0, 43, 135, 0.5)" }}
          className="  px-4   pb-5 bg-transparent  w-4/5 border-b  focus:outline-none placeholder:text-[#002B87B2]       placeholder:font-nova     "
          placeholder="Email "
        />
        <input
          type="text"
        ...
        <textarea
          style={{ borderBottomColor: "rgba(0, 43, 135, 0.5)" }}
          className=" placeholder:text-[#002B87B2]       placeholder:font-nova      w-4/5 bg-transparent px-4 pb-5 border-b focus:outline-none"
          placeholder="Your message ..."
        ></textarea>
        <div className=" flex w-4/5 justify-start">
          <button className=" justify-start font-nova-semibold  text-lg  inline-flex bg-transparent border-none mb-5 items-center gap-2 text-[#0F0D0F] font-[600] ">
            Send
            <svg
              width="25"
              height="25"
